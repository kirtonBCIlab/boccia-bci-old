...
//    void Start()
//    {
//        targetHeight = elevatorPlate.transform.position.y;
//    }
...
//            targetHeight = -0.05204198f;
//        }
//        if (targetHeight < 2.25f)
//        {
//            targetHeight = 2.25f;
//        }

//        targetHeight = targetHeight + change;
...
//    void Update()
//    {
//        currentHeight = elevatorPlate.transform.position.y;
//        Debug.Log(targetHeight + ":" + currentHeight);

//        //elevatorPlate.transform.position.y = Mathf.Lerp(currentHeight, targetHeight, heightSpeed * Time.deltaTime);
